// const isServiceAvailableInUserLocation = async (point: any, cityPolygon: any) => {
//   const x = point[0];
//   const y = point[1];
//   let isInside = false;
...
// console.log(isServiceAvailableInUserLocation(gpsCoordinateInside, polygonCoordinates)); // Should print true
// console.log(isServiceAvailableInUserLocation(gpsCoordinateOutside, polygonCoordinates)); // Should print false
