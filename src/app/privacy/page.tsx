                        ...
                        <div className="card">
                            <div className="card-body">
                                <div>
                                    ...
                                    <p>This Privacy Policy outlines how ICESSPOOL (`we,` `us,` or `our``) collects, uses, discloses, and secures personal and sensitive user data. By using ICESSPOOL, you agree to the terms described in this policy.</p>
                                    ...
                                    <p>By using ICESSPOOL, you consent to the terms outlined in this Privacy Policy.</p>

                                    <address>
                                        Ministry of Sanitation and Water Resources<br />
                                        Starlets 91 Rd, Accra<br />
                                        Accra, Ghana<br />
                                        <a href="http://app.icesspool.net/">http://app.icesspool.net/</a><br />
                                        Email: <a href="mailto:support@icesspool.net">App Email</a><br />
                                        Phone: 0209125718
                                    </address>
                                </div>
