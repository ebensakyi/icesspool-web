...
//             let status = Number(formData.get("status"));
//             let regionId = Number(formData.get("regionId"));
//             let serviceId = Number(formData.get("serviceId"))
//             let tankCapacity = Number(formData.get("tankCapacity"))

//             await prisma.truckClassification.create({
//                 name: name,
//                 status: status,
//                 regionId: regionId,
...
//                                         </label>
//                                         <div className="col-sm-12">
//                                             <input type="text" name='tankCapacity' required className="form-control" placeholder='Enter capacity' />
//                                         </div>
//                                     </div>
